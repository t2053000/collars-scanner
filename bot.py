...
# ---------------------------------------------------------------------------
# DCA trade callback (shows preview, waits for YES TICKER text reply)
# ---------------------------------------------------------------------------
...
async def cb_trade(update, context):
    ...
    logger.info(
        f"cb_trade: ticker={hit.get('ticker')} walk_step={walk_step} type={trade_type}"
    )
...
# ---------------------------------------------------------------------------
# Text reply handler (DCA: YES TICKER only)
# ---------------------------------------------------------------------------
